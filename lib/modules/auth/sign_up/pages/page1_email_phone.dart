...
class Page1EmailPhone extends StatefulWidget {
  const Page1EmailPhone({super.key, this.margin});

  final EdgeInsets? margin;

  @override
  State<Page1EmailPhone> createState() => _Page1EmailPhoneState();
}

class _Page1EmailPhoneState extends State<Page1EmailPhone> {
  // State
